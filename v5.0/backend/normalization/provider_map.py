...
PROVIDER_PRIORITY: dict[str, DataTypeMap] = {
    ...
    # ── Soccer ────────────────────────────────────────────
    "epl": {
        "games":        ["footballdata", "apisports", "statsbomb", "espn"],
        "teams":        ["espn", "statsbomb"],
        "players":      ["statsbomb", "footballdata", "espn"],
        "standings":    ["footballdata", "apisports", "espn"],
        "player_stats": ["statsbomb", "apisports", "espn"],
        "odds":         ["odds", "oddsapi"],
        "player_props": ["odds", "oddsapi"],
        "injuries":     ["espn"],
        "news":         ["espn"],
    ...
    "laliga": {
        "games":        ["apisports", "statsbomb", "espn"],
        "teams":        ["espn", "statsbomb"],

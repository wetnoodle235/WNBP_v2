...
# to the flat entity directory name under normalized_curated/ncaaf/.
# Types mapping to None are intentionally skipped (non-entity artefacts).
NCAAF_TYPE_TO_ENTITY: dict[str, str | None] = {
    ...
    "ratings_sp":       "ratings",
    "ratings_sp_conferences": "ratings",
    "ratings_srs":      "ratings",
    "ratings_elo":      "ratings",
    "ratings_fpi":      "ratings",
    ...
    "recruiting_groups": "recruiting",
    "talent":           "recruiting",
    "stats_advanced":   "advanced",
    "stats_game_advanced": "advanced",
    "stats_game_havoc": "advanced",
    "ppa_teams":        "advanced",
    "ppa_games":        "advanced",
    "ppa_players_season": "advanced",
    "ppa_players_games": "advanced",
    "ppa_predicted":    "advanced",
    "stats_season":     "player_stats",
    "stats_player_season": "player_stats",
    "game_box_advanced": "advanced",
    "wp_pregame":       "advanced",
    "metrics_wp":       "advanced",
    "metrics_fg_ep":    "advanced",
